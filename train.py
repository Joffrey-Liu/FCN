...
modelFns = { 'vgg_segnet':VGGSegnet , 'vgg_unet':VGGUnet , 'vgg_unet2':VGGUnet2 , 'fcn8':FCN8 , 'fcn32':FCN32   }
...
if not validate:
	for ep in range( epochs ):
		...
		m.save_weights( save_weights_path + "." + str( ep+4 ) )
		m.save( save_weights_path + ".model." + str( ep+4 ) )
else:
	for ep in range( epochs ):
