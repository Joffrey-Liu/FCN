...
#VGG_Weights_path = file_path+"/../data/vgg16_weights.h5"
#vgg16_weights
file = listdir(file_path+"/../data")
def VGGSegnet( n_classes ,  input_height=416, input_width=608 , vgg_level=3):
	...
	print("model construct2~~~~~")
	print("weight path", VGG_Weights_path)
	vgg.load_weights(VGG_Weights_path)
	print("model vgg load weight~~~~~")
